...
namespace SmartTrip.Migrations
{
    public partial class model : Migration
    {
        public override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                c => new
                    {
                        ...
                        UserName = c.String(),
                        DestinationCityId = c.Int(),
                        StartingCityId = c.Int(),
                        ScheduleId = c.Int()
                    })
            ...
            migrationBuilder.AddForeignKey(
                "Transit",
                "FK_Transit_City_DestinationCityId",
                new[] { "DestinationCityId" },
                "City",
                new[] { "Id" },
                cascadeDelete: false);
            ...
            migrationBuilder.AddForeignKey(
                "Transit",
                "FK_Transit_City_StartingCityId",
                new[] { "StartingCityId" },
                "City",
                new[] { "Id" },
                cascadeDelete: false);
            ...
            migrationBuilder.AddForeignKey(
                "Trip",
                "FK_Trip_Country_DestinationCountryId",
                new[] { "DestinationCountryId" },
                "Country",
                new[] { "Id" },
                cascadeDelete: false);
        }
        ...
        public override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey("Transit", "FK_Transit_City_DestinationCityId");
            
            migrationBuilder.DropForeignKey("Transit", "FK_Transit_City_StartingCityId");
            
            migrationBuilder.DropForeignKey("Trip", "FK_Trip_City_StartingCityId");
            
            migrationBuilder.DropForeignKey("City", "FK_City_Country_CountryId");
            
            migrationBuilder.DropForeignKey("Trip", "FK_Trip_Country_DestinationCountryId");
            ...
            migrationBuilder.DropForeignKey("Note", "FK_Note_Schedule_Id");
